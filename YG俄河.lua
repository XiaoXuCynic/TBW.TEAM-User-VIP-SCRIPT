...
local dartTab = Window:Tab({Title = "打击类", Icon = "target"})

dartTab:Section({ Title = "忍者杀戮", Icon = "target", Opened = true })
...
Settings:Button({
    ...
    Callback = function()
        ...
        setclipboard("SCRIPT设置: " .. game:GetService("HttpService"):JSONEncode(settings))
        playSound()
    end
})
